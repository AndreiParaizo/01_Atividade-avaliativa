...
Autor: "Andrei Paraizo dos Santos"
Date: "Estatistica 2021.1"
...
```
**Questao 01**
**a** O erro é que ele considera a mala mais pesada sendo a que representa o valor do quartis superior e análise de análise que pelo boxplot existem malas mais pesadas entre esse quartil e o limite superior (29kg), onde está localizado 25% da amostra (malas). Portanto, 23kg não representa a mala mais pesada da distribuição.
...
**c** No histograma, é possível perceber uma certa assimetria entre os valores, por isso, acredito que a mediana representa a melhor medida central do conjunto de dados.
...
x ,
 ...
 col  =  ' azul claro ' , XLAB  =  '  ' , ylab  =  '  ' , axes  =  F ,
 main  =  ' Positivo enviesado '
)
linhas (densidade ( x , bw  =  1 ), col  =  ' vermelho ' , lwd  =  3 )"
```
...
```{r}
"co2_tidy  <-  dados_co2 % > %"
  "pivot_longer (! ano , names_to  = mes , values_to  = ppm)"
...
Observando o gráfico, é possível perceber que a variável ppm aumentou com o passar dos anos.

**Questao 7**
**a** Criei um tibble da seguinte forma:
```{r}
"tabela_tibble  <- tibble (
   ~ nome ,        ~ altura , ~ peso ,
    Ana  ,        155 ,      50 ,
    Ludmilla  ,   158 ,      61 ,
    Cristina  ,   162 ,      65 ,
...
```{r}
"média ( tabela_tibble $ peso )"
"mediana ( tabela_tibble $ peso )"
"sd ( tabela_tibble $ peso )"

"média ( tabela_tibble $ altura )"
"mediana ( tabela_tibble $ altura )"
"sd ( tabela_tibble $ altura )"
"Para altura encontrei"
"- média = 166"
"- mediana = 169"

"desvio padrao = 6,78233"
"Para peso encontrei"
"- média = 67,375"
"- mediana = 66,5"
"- desvio padrao = 10,04188"
```
